...
本文档大部分编写于大语言模型流行之前的2022年。

**但在今天，本文档中所介绍的大部分内容，其最高效的自学方式，都是通过大语言模型。**

本文档计划进行一次全面的修订，以适应“结合大语言模型进行课前自学的需要”。

在完成修订之前，同学们也可以自行探索，将本文档的内容喂给大语言模型，请大语言模型给出总结、给出练习建议，等等。